...
export default defineNuxtConfig({
	...
	app: {
		head: {
			...
			htmlAttrs: { lang: 'en' },
			link: [
				{ rel: 'canonical', href: 'https://hrt.mishu.dev' },
				{ rel: 'icon', href: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b0/Transgender_Pride_flag.svg/800px-Transgender_Pride_flag.svg.png' }
			],
			meta: [
				{
				...
				{ name: 'identifier-URL', content: 'https://hrt.mishu.dev' },
				...
				{ name: 'shortlink', content: 'https://hrt.mishu.dev' },
				{
					name: 'subject',
					content: 'HRT follower'
				},
				...
				{ name: 'url', content: 'https://hrt.mishu.dev' },
				{
				...
				{ property: 'og:title', content: 'HRT follower' },
				{ property: 'og:type', content: 'website' },
				{ property: 'og:url', content: 'https://hrt.mishu.dev' },
				{ property: 'og:image', content: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b0/Transgender_Pride_flag.svg/800px-Transgender_Pride_flag.svg.png' }
			]
		}
	}
});
